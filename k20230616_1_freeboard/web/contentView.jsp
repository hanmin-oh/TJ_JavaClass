...
<div class="m-3">
    <table class="table" style="width: 800px; margin-left: auto; margin-right: auto; ">
        <tr class="table-primary" >
            <th colspan="5" style="font-size: 30px; text-align: center; border-radius: 15px;">게시글 보기</th>
        </tr>
        ...
        <tr>
            <th colspan="1" class="align-middle" >제목</th>
            <td colspan="4">
        ...
        <tr>
            <th colspan="1" class="align-middle" >내용</th>
            <td colspan="4">
                <c:set var="subject" value="${fn:replace(vo.subject , '<' , '&lt;')}"/>
                <c:set var="subject" value="${fn:replace(subject , '>' , '&gt;')}"/>
