...
//		논리값을 기억하는 변수나 리턴 타입이 논리값인 메소드의 이름은 "is"로 시작하는 관행이다.
		boolean isLeapYear = year % 4 == 0  && !(year % 100 == 0) || (year % 400 == 0);
		
//		테스트 결과 2023년은 평년, 2024년은 윤년, 2000년 윤년, 2100년 평년
		if(isLeapYear) {
...
//		삼항연산자(?:)
//		삼항연산자는 조건식을 비교한 후 참이나 거짓일 대 실행할 문장이 각각 1문장일때 사용하면 편리하다.
//		형식 : 조건식 ? 참일 때 실행할 문장 : 거짓일 대 실행할 문장
		
		System.out.println(isLeapYear ? "윤" : "평");
		System.out.println(year + "년은 " + (isLeapYear ? "윤" : "평") + "년입니다.");
		System.out.printf("%d년은 %s년입니다.\n", year, (isLeapYear ? "윤" : "평" + "년입니다."));
