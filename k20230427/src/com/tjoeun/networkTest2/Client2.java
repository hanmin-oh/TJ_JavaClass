...
public class Client2 {
	...
	public static void main(String[] args) {
		...
		Scanner scan = null; //서버로 전송한 메시지를 입력받는 스캐너
		
		try {
			socket = new Socket("192.168.0.38" , 10004);
			System.out.println("192.168.0.38 서버의 10004번 포트로 접속합니다.");
